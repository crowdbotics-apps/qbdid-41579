"""
Django settings for qbdid_41579 project.
...
WSGI_APPLICATION = 'qbdid_41579.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qbdid_41579 API",
    "DESCRIPTION": "API documentation for qbdid_41579 App",
    "VERSION": "v1",
}
